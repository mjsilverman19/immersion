  ...
  return (
    <main className="min-h-[100dvh] bg-background px-5 py-7 text-foreground md:px-10 md:py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="type-eyebrow mt-10 text-primary">Methodology</p>
        <h1 className="type-headline mt-2">A modeled typical week, not live tracking.</h1>
        ...
        <section className="brand-card mt-10 p-5">
          <h2 className="type-headline">Current footprint</h2>
        ...
        <details className="mt-8 border-t border-border py-6">
          <summary className="type-button cursor-pointer">Technical details</summary>
...
function Method({ title, children }: { title: string; children: React.ReactNode }) {
  return <div><h2 className="type-headline">{title}</h2><p className="type-body mt-1.5 leading-relaxed text-muted-foreground">{children}</p></div>;
}
